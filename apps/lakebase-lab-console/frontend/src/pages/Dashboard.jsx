...
import {
  ...
  ExternalLink, Cpu, Table, Layers, Key, Shield, BookOpen, Search
} from '../icons'
    ...
    <div>
      ...
      <div className="card">
        ...
        <div className="quick-actions-grid">
          ...
          <QuickActionCard pageId="sync" Icon={RefreshCw} title="Synced Tables" desc="Push Delta tables into Lakebase (Reverse ETL), plus reverse CDC preview" onNavigate={onNavigate} config={ctx?.config} />
